...
const FECHA_INICIO = "2025-10-08 00:30:00";
const FECHA_FIN = "2025-10-13 16:50:00";
...
async function enviarMensajes() {
    ...
    try {
        ...
        const [rows] = await con.query(
            `SELECT resource, seller_id, autofecha FROM db_shipments WHERE autofecha >= ? AND autofecha <= ? and seller_id in (700634176,161284628,1434981515) `,
